...
const openGraphs: Record<string, string> = {
  Github: 'https://github.com',
  Nexus: 'https://www.nexusmods.com',
  Bookshelves: 'https://bookshelves.ink',
  TwitterBalletOParis:
  ...
  SpotifyRaya: 'https://open.spotify.com/track/6xMpUNOfaSkyywPiFFXZFh',
}
...
ReactDOM.createRoot(document.getElementById('root') as HTMLElement).render(
  <div className="space-y-5 my-5 max-w-2xl mx-auto">
    {Object.entries(openGraphs).map((url, i) => (
      <div>
        <div>{url[0]}</div>
        <SocialOEmbed url={url[1]} key={i} />
      </div>
    ))}
