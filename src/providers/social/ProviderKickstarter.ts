...
export default class ProviderKickstarter extends ProviderModule {
  protected type: Social = 'kickstarter'
  protected regex = /(?:https?:\/\/)?(?:www\.)?kickstarter\.com\/projects\/([a-zA-Z0-9]+)/ig
